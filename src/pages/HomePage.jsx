...
function HomePage() {
  ...
  const categories = [
    "All",
    ...new Set(allUmkmData.map((umkm) => umkm.kategori)),
  ];
    ...
    >
      <div className="min-h-screen bg-background text-text">
        ...
        <section
          ...
          style={{ backgroundImage: "url(https://images.unsplash.com/photo-1497935586351-b67a49e012bf?ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80)" }}
        >
          ...
          <div className="absolute bottom-0 left-0 w-full h-auto z-10">
            <svg viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
              <path fill="#F9F5F0" fillOpacity="1" d="M0,224L80,218.7C160,213,320,203,480,186.7C640,171,800,149,960,160C1120,171,1280,213,1360,234.7L1440,256L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
            </svg>
          </div>
        </section>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {categories.map((category) => (
                <button
                  key={category}
                  className={`py-3 px-6 rounded-full text-lg font-semibold transition-all duration-200 ${selectedCategory === category
